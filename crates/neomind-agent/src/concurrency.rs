...
mod tests {
    ...
    async fn test_session_concurrency_basic() {
        ...
        let session_id = neomind_core::SessionId::from("session_1");
    ...
    async fn test_global_concurrency_limit() {
        ...
        let session1 = neomind_core::SessionId::from("session_1");
        let session2 = neomind_core::SessionId::from("session_2");
