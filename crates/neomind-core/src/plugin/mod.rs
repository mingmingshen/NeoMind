...
impl PluginRegistry {
    ...
    /// # Example
    /// ```no_run
    /// use neomind_core::plugin::{PluginRegistry, Plugin, PluginMetadata};
    /// use std::sync::Arc;
    ///
    /// struct MyPlugin;
    ///
    ...
    ///     }
    ///
    ///     fn initialize(&mut self, config: &serde_json::Value) -> neomind_core::plugin::Result<()> {
    ///         // Initialize
    ///         Ok(())
    ///     }
    ///
    ...
    ///
    /// ```no_run
    /// # use neomind_core::plugin::PluginRegistry;
