...
impl From<edge_ai_core::LlmError> for AutomationError {
    fn from(err: edge_ai_core::LlmError) -> Self {
        AutomationError::LlmError(err.to_string())
    }
}

impl From<edge_ai_rules::RuleError> for AutomationError {
    fn from(err: edge_ai_rules::RuleError) -> Self {
