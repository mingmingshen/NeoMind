...
fn convert_connection_config(
    storage_config: edge_ai_storage::device_registry::ConnectionConfig,
) -> ConnectionConfig {
    ConnectionConfig {
...
) -> edge_ai_storage::device_registry::ConnectionConfig {
    edge_ai_storage::device_registry::ConnectionConfig {
    ...
    pub async fn load_from_storage(&self) -> Result<(), DeviceError> {
        ...
        for storage_template in storage_templates {
            ...
            let mode = match storage_template.mode {
                edge_ai_storage::device_registry::DeviceTypeMode::Simple => DeviceTypeMode::Simple,
                edge_ai_storage::device_registry::DeviceTypeMode::Full => DeviceTypeMode::Full,
            };
    ...
    pub async fn save_to_storage(&self) -> Result<(), DeviceError> {
        ...
        for template in templates.values() {
            ...
            let mode = match template.mode {
                DeviceTypeMode::Simple => edge_ai_storage::device_registry::DeviceTypeMode::Simple,
                DeviceTypeMode::Full => edge_ai_storage::device_registry::DeviceTypeMode::Full,
            };
