...
use edge_ai_devices::mdl::{MetricDataType, MetricValue};
...
async fn create_test_registry_with_template() -> DeviceRegistry {
    ...
    let template = edge_ai_devices::registry::DeviceTypeTemplate {
        ...
        mode: edge_ai_devices::registry::DeviceTypeMode::Simple,
        metrics: vec![
            MetricDefinition {
