...
> 📚 **完整文档已迁移至 [NeoMind Wiki](https://wiki.camthink.ai/zh/docs/neomind/product-overview/what-is-neomind)。** 本 README 仅作快速概览，详细指南请访问 Wiki：
>
> - [NeoMind 是什么？](https://wiki.camthink.ai/zh/docs/neomind/product-overview/what-is-neomind) — 产品概览与核心理念
> - [五分钟快速开始](https://wiki.camthink.ai/zh/docs/neomind/quick-start/five-minute-guide) — 快速上手
> - [安装与配置](https://wiki.camthink.ai/zh/docs/neomind/user-guide/install-setup) — 桌面端、服务器、Docker 部署
> - [开发者指南](https://wiki.camthink.ai/zh/docs/neomind/developer-guide/overview) — API、扩展、集成
...
- **[开发扩展](https://github.com/camthink-ai/NeoMind-Extensions)** — 为新的数据源、AI 模型或集成创建扩展。参考 [开发者指南](https://wiki.camthink.ai/zh/docs/neomind/developer-guide/overview) 快速上手，然后向市场提交 PR。
...
> 完整流程请参考 Wiki 的 [五分钟快速开始](https://wiki.camthink.ai/zh/docs/neomind/quick-start/five-minute-guide) 和 [安装与配置](https://wiki.camthink.ai/zh/docs/neomind/user-guide/install-setup)。
...
详见 [开发者指南](https://wiki.camthink.ai/zh/docs/neomind/developer-guide/overview) 和 [NeoMind-Extensions](https://github.com/camthink-ai/NeoMind-Extensions)。

## 文档

所有用户、安装和开发文档均位于 **[NeoMind Wiki](https://wiki.camthink.ai/zh/docs/neomind/product-overview/what-is-neomind)**：

| Wiki 板块 | 内容 |
|----------|------|
| [产品概览](https://wiki.camthink.ai/zh/docs/neomind/product-overview/what-is-neomind) | NeoMind 是什么、核心概念、架构 |
| [快速开始](https://wiki.camthink.ai/zh/docs/neomind/quick-start/five-minute-guide) | 五分钟跑起第一个实例 |
| [安装与配置](https://wiki.camthink.ai/zh/docs/neomind/user-guide/install-setup) | 桌面端、服务器、Docker、配置 |
| [开发者指南](https://wiki.camthink.ai/zh/docs/neomind/developer-guide/overview) | REST/WebSocket API、扩展、集成 |
