...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/v-0.8.0-information.svg" alt="版本">
  ...
  <table>
    <tr>
      ...
      <td align="center" width="35%" valign="top">
        <img src="docs/img/mobile_web.png" alt="移动端" width="220" style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.12);" />
        <br/><sub><b>移动端</b></sub>
      </td>
    </tr>
  </table>
