...
export const TopNav = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    <TooltipProvider delayDuration={500}>
      <nav ref={innerRef} className="fixed top-0 left-0 right-0 min-h-16 bg-surface-glass backdrop-blur-xl border-b border-glass-border flex items-center px-4 sm:px-6 z-10" style={{paddingTop: 'env(safe-area-inset-top, 0px)'}}>
