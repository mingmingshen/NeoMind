...
const MARKETPLACE_PLUGINS: MarketplacePlugin[] = [
  ...
  {
    id: 'hass-adapter',
    name: 'Home Assistant Adapter',
    description: 'Home Assistant 集成，支持设备发现和控制',
    longDescription: '与 Home Assistant 系统集成，自动发现 HASS 设备并映射为 NeoTalk 设备。',
    version: '1.0.0',
    author: 'NeoTalk',
    category: 'devices',
    icon: 'Home',
    ...
    official: true,
    config: { type: 'builtin' },
    tags: ['home-assistant', 'hass', 'smart-home'],
  },
  {
    id: 'modbus-adapter',
    name: 'Modbus RTU/TCP Adapter',
    description: 'Modbus 工业协议适配器，支持传感器和控制器',
    longDescription: '支持 Modbus RTU 和 TCP 协议，可用于读取工业传感器、PLC 等设备数据。',
    version: '1.0.0',
    author: 'NeoTalk',
    category: 'devices',
    icon: 'Server',
    ...
    rating: 4.5,
    config: { type: 'builtin' },
    tags: ['modbus', 'industrial', 'rtu', 'tcp'],
  },
