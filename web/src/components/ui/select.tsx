...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal container={getPortalRoot()}>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-[200] max-h-96 min-w-[8rem] overflow-hidden rounded-xl bg-popover text-popover-foreground text-left shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-1.5 data-[side=left]:slide-in-from-right-1.5 data-[side=right]:slide-in-from-left-1.5 data-[side=top]:slide-in-from-bottom-1.5",
...
>(({ className, children, icon, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-2 sm:py-1.5 min-h-[44px] sm:min-h-0",
      className
    )}
    {...props}
  >
