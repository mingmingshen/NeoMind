...
export function createChartConfig(config: {
  ...
  sections.push({
    ...
    props: {
      dataSource: config.dataSource,
      onChange: config.onDataSourceChange,
      allowedTypes: ['device-metric', 'system', 'extension', 'extension-command', 'transform'],  // Charts support device metrics, system metrics, extension metrics, extension commands, and transforms
