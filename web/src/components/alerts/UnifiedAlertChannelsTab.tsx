    ...
    return (
      <>
        ...
        <UnifiedFormDialog
          ...
          onOpenChange={(open) => { if (!open) setFilterDialogChannel(null) }}
          title={t('common:messages.channels.filterConfig')}
          description={t('common:messages.channels.filterConfigDesc')}
          width="sm"
