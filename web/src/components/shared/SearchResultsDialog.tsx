...
export function SearchResultsDialog({ open, onOpenChange, initialQuery = "" }: SearchResultsDialogProps) {
  ...
  return (
    <UnifiedFormDialog
      ...
      title={t('search.title', { defaultValue: 'Global Search' })}
      description={t('search.description', { defaultValue: 'Search devices, rules, workflows, and alerts' })}
    ...
    >
      <div className="space-y-4">
        ...
        {/* Results */}
        {loading ? null : hasSearched && results.length === 0 ? (
