                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <div className="flex items-center gap-1 text-muted-foreground/40">
                                {backend.capabilities?.supports_multimodal && (
                                  <span title={t('chat:model.supportsVision')}><Eye className="h-3 w-3 fill-current" /></span>
                                )}
                                {backend.capabilities?.supports_tools && (
                                  <span title={t('chat:model.supportsTools')}><Wrench className="h-3 w-3 fill-current" /></span>
                                )}
                                {backend.capabilities?.supports_thinking && (
                                  <span title={t('chat:model.supportsThinking')}><Brain className="h-3 w-3 fill-current" /></span>
                                )}
                              </div>
                            </div>
