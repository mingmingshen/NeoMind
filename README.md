...
[![Version: 0.7.9](https://img.shields.io/badge/v-0.7.9-information.svg)](https://github.com/camthink-ai/NeoMind/releases)
...
```bash
curl -fsSL https://raw.githubusercontent.com/camthink-ai/NeoMind/main/scripts/install.sh | VERSION=0.7.9 sh
```
